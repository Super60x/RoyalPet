...
export default function GenerationProgress({
  ...
  // Progress bar: estimate based on ~60 seconds
  const progress = Math.min((elapsed / 60) * 100, 95);

  return (
    <div className="w-full max-w-lg mx-auto text-center">
      {/* Progress bar */}
      <div className="w-full h-2 bg-royal-brown/10 rounded-full overflow-hidden mb-6">
        <div
      ...
      {/* Rotating text */}
      <p className="text-lg font-heading text-royal-brown italic mb-3 min-h-[1.75rem] transition-opacity duration-500">
